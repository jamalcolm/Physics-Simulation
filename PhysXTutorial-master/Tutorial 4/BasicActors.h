...
namespace PhysicsEngine
{
	...
	public:
		//Compound shape for top of catapult
		CompoundShape(const PxTransform& pose = PxTransform(PxIdentity), PxVec3 dimensions = PxVec3(.5f, .5f, .5f), PxReal density = 1.f)
			: DynamicActor(pose)
		{
			
			CreateShape(PxBoxGeometry(PxVec3(1.0f,0.1f,1.0f)), density);
			CreateShape(PxBoxGeometry(0.3f, 1.0f, 0.1f), density);
			CreateShape(PxBoxGeometry(0.3f, 1.0f, 0.1f), density);

			GetShape(0)->setLocalPose(PxTransform(PxVec3(0.0f, 0.0f, 0.0f)));
			GetShape(1)->setLocalPose(PxTransform(PxVec3(0.0f, 0.9f, thickness)));
			GetShape(2)->setLocalPose(PxTransform(PxVec3(0.0f, 0.9f, -thickness)));
		}
	};

	class CatapultBase : public DynamicActor
	{
	public:
		//Catapult object (without arm)
		CatapultBase(const PxTransform& pose = PxTransform(PxIdentity), PxVec3 dimensions = PxVec3(.5f, .5f, .5f), PxReal density = 1.f)
			: DynamicActor(pose)
		{
			density *= 100000000000.f;
			CreateShape(PxBoxGeometry(PxVec3(5.0f, 1.0f, 4.0f)), density);
			CreateShape(PxBoxGeometry(PxVec3(1.0f, 6.0f, 1.0f)), density);
			CreateShape(PxBoxGeometry(PxVec3(1.0f, 6.0f, 1.0f)), density);

			GetShape(0)->setLocalPose(PxTransform(PxVec3(0.0f, 0.0f, 0.0f)));
			GetShape(1)->setLocalPose(PxTransform(PxVec3(2.0f, 7.0f, -2.0f)));
			GetShape(2)->setLocalPose(PxTransform(PxVec3(2.0f, 7.0f, 2.0f)));
		}
	};
	...
	public:
		//Catapult arm
		CatapultArm(const PxTransform& pose = PxTransform(PxIdentity), PxVec3 dimensions = PxVec3(.5f, .5f, .5f), PxReal density = 1.f)
			: DynamicActor(pose)
		{
			CreateShape(PxBoxGeometry(PxVec3(5.0f, 1.0f, 1.0f)), density);
			CreateShape(PxBoxGeometry(PxVec3(2.0f, 1.0f, 2.0f)), density);

			GetShape(0)->setLocalPose(PxTransform(PxVec3(0.0f, 0.0f, 0.0f)));
			GetShape(1)->setLocalPose(PxTransform(PxVec3(7.0f, -1.0f, 0.0f)));
		}
	};
	...
	public:
		//Windmill base
		WindmillBase(const PxTransform& pose = PxTransform(PxIdentity), PxVec3 dimensions = PxVec3(.5f, .5f, .5f), PxReal density = 1.f)
			: DynamicActor(pose)
		{
			CreateShape(PxBoxGeometry(PxVec3(5.0f, 10.0f, 5.0f)), density);
			CreateShape(PxBoxGeometry(PxVec3(3.0f, 7.0f, 3.0f)), density);
			CreateShape(PxBoxGeometry(PxVec3(1.0f, 1.0f, 1.0f)), density);

			GetShape(0)->setLocalPose(PxTransform(PxVec3(0.0f, 0.0f, 0.0f)));
			GetShape(1)->setLocalPose(PxTransform(PxVec3(2.0f, 17.0f, 0.0f)));
			GetShape(2)->setLocalPose(PxTransform(PxVec3(5.5f, 20.0f, 0.0f)));
		}
	};

	class WindmillSpokes : public DynamicActor
	{
	public:
		//Windmill spokes
		WindmillSpokes(const PxTransform& pose = PxTransform(PxIdentity), PxVec3 dimensions = PxVec3(.5f, .5f, .5f), PxReal density = 1.f)
			: DynamicActor(pose)
		{
			CreateShape(PxBoxGeometry(PxVec3(1.0f, 20.0f, 1.0f)), density);
			CreateShape(PxBoxGeometry(PxVec3(1.0f, 1.0f, 20.0f)), density);

			CreateShape(PxBoxGeometry(PxVec3(1.0f, 5.0f, 2.0f)), density);
			CreateShape(PxBoxGeometry(PxVec3(1.0f, 2.0f, 5.0f)), density);
			CreateShape(PxBoxGeometry(PxVec3(1.0f, 5.0f, 2.0f)), density);
			CreateShape(PxBoxGeometry(PxVec3(1.0f, 2.0f, 5.0f)), density);

			GetShape(2)->setLocalPose(PxTransform(PxVec3(0.f, 15.0f, 2.f)));
			GetShape(3)->setLocalPose(PxTransform(PxVec3(0.f, 2.0f, -15.f)));
			GetShape(4)->setLocalPose(PxTransform(PxVec3(0.f, -15.0f, -2.f)));
			GetShape(5)->setLocalPose(PxTransform(PxVec3(0.f, -2.0f, 15.f)));
		}
	};
	...
	public:
		...
		GoalPost(const PxTransform& pose = PxTransform(PxIdentity), PxVec3 dimensions = PxVec3(.5f, .5f, .5f), PxReal density = 1.f)
			: DynamicActor(pose)
		{
			CreateShape(PxBoxGeometry(3.0f, 30.0f ,3.0f), density);
			CreateShape(PxBoxGeometry(3.0f, 30.0f, 3.0f), density);
			CreateShape(PxBoxGeometry(3.0f, 3.0f, 15.0f), density);

			GetShape(0)->setLocalPose(PxTransform(PxVec3(0.0f, 30.0f, -15.f)));
			GetShape(1)->setLocalPose(PxTransform(PxVec3(0.0f, 30.0f, 15.f)));
			GetShape(2)->setLocalPose(PxTransform(PxVec3(0.0f, 17.0f, 0.0f)));
	...
	public:
		...
		RevoluteJoint(Actor* actor0, const PxTransform& localFrame0, Actor* actor1, const PxTransform& localFrame1)
		{
			...
			myActor1 = (PxRigidActor*)actor1->Get();
			joint = PxRevoluteJointCreate(*GetPhysics(), px_actor0, localFrame0, myActor1, localFrame1);

			joint->setActors(px_actor0, (PxRigidActor*)actor1->Get());
